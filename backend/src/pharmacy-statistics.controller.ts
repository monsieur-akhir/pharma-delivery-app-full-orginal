...
@ApiTags('statistics')
export class PharmacyStatisticsRootController {
  private readonly logger = new Logger(PharmacyStatisticsRootController.name);

  constructor(private readonly databaseService: DatabaseService) {
    this.logger.log('PharmacyStatisticsRootController initialized');
  }
