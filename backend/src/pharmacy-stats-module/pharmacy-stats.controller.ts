...
@ApiTags('statistics')
export class PharmacyStatsModuleController {
  private readonly logger = new Logger(PharmacyStatsModuleController.name);

  constructor(private readonly databaseService: DatabaseService) {
    this.logger.log('PharmacyStatsModuleController initialized');
  }
