...
// Un contrôleur indépendant au niveau racine avec chemin explicite
@Controller('stats')
@ApiTags('statistics')
export class StatsEndpointController {
  private readonly logger = new Logger(StatsEndpointController.name);

  constructor(private readonly databaseService: DatabaseService) {
    this.logger.log('StatsEndpointController initialized');
  }
